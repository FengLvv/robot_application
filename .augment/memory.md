...
### 研究主题
- **服务边界协商**: 用户如何与机器人协商私密空间的服务边界
- **模糊指令消解**: 行为级歧义（"收拾到什么程度？"）的消解策略
...
| 场景 | 文档 | 状态 | 核心指令 |
|------|------|------|----------|
| **A. 整理卧室** | `scenario_a_bedroom.md` | ✅ 已细化 | "帮我收拾一下卧室" |
| B. 准备晚餐 | - | ⏳ 待开发 | "晚上弄点吃的" |
| **C. 接待访客** | `scenario_c_visitor.md` | 🔄 进行中 | 有人按门铃（用户不在家） |
...
已有研究                    我们的创新
─────────────────────      ─────────────────────
物体级歧义（哪个杯子？）    行为级歧义（收拾到什么程度？）
隐私担忧（会被监视吗？）    服务边界协商（能做什么？）
```

### 关键决策
| 日期 | 决策 | 原因 |
|------|------|------|
| 2026-02-13 | 选择方向3（服务边界+模糊指令） | 研究空白明确，文献支持充分 |
| 2026-02-13 | 首选场景A（整理卧室） | ACM 2025确认卧室隐私最敏感 |
| 2026-02-13 | 场景A文档细化完成 | 包含完整RQs、假设、测量变量 |
| 2026-02-13 | 开始细化场景C（接待访客） | 决策边界问题最突出 |
